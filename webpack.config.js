...
Encore
    ...
    .addAliases({
        ...
        '@appPages': path.resolve(__dirname, './assets/app/js/pages/components'),
    ...
    .addEntry('app_ads', './assets/app/js/pages/ads.js')
    ...
    .addEntry('admin_demandes', './assets/admin/js/pages/demandes.js')
